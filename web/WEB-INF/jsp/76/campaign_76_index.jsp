        ...
        <div style="padding:0 10px;">
            ...
            <div class="p-header list">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product1" data-price="48" data-productID="0001" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
            <div class="p-header list">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product2" data-price="52" data-productID="0002" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
            <div class="p-header list">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product3" data-price="58" data-productID="0003" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
            <div class="p-header list">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product4" data-price="98" data-productID="0004" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
            <div class="p-header list">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product5" data-price="108" data-productID="0005" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
            <div class="p-header list last">
                ...
                <div class="p-number item">
                    <div class="jian">&nbsp;</div>
                    <div class="np">
                        <input class="inputn" type="number" name="product6" data-price="106" data-productID="0006" maxlength="4" readonly value="0" />
                    </div>
                    <div class="jia">&nbsp;</div>
                </div>
            </div>
